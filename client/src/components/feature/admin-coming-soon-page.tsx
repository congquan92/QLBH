...
export function AdminComingSoonPage({ title, description, note }: AdminComingSoonPageProps) {
    return (
        <AdminPageShell title={title} description={description}>
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Trang này đang được hoàn thiện. Bạn có thể mở rộng CRUD theo API backend ngay tại đây.</CardDescription>
                </CardHeader>
