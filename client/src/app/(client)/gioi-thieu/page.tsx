        ...
        <div className="bg-white">
            <div className="container mx-auto px-4 py-12 lg:py-20">
                ...
                <div className="text-center mb-12 lg:mb-16">
                    ...
                    <h1 className="text-3xl md:text-4xl lg:text-5xl font-semibold tracking-[0.08em]">THƯƠNG HIỆU THỜI TRANG NAM ARES CLUB</h1>
                </div>
                ...
                <section className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center mb-20 lg:mb-24">
                    ...
                    <div className="w-full">
                        <Image src="https://theme.hstatic.net/200000690725/1001078549/14/about01_introduce1_img.jpg?v=1065" alt="Bộ sưu tập thời trang ARES CLUB" width={1200} height={800} priority className="w-full h-auto object-cover" />
                    </div>

                    {/* Text */}
                    <div className="space-y-4 text-sm md:text-base leading-relaxed text-muted-foreground">
                        <p className="tracking-[0.35em] text-xs md:text-sm uppercase text-muted-foreground">ARES CLUB</p>
                        <h2 className="text-2xl md:text-3xl font-semibold tracking-[0.08em] mb-2 text-foreground">CÂU CHUYỆN THƯƠNG HIỆU</h2>

                        <p>
                            ARES CLUB là thương hiệu thời trang nam được định hướng theo phong cách hiện đại, lịch lãm và trẻ trung. Từ những ngày đầu thành lập, chúng tôi luôn theo đuổi mục tiêu mang lại cho phái mạnh những lựa chọn trang phục chỉn
                            chu nhưng vẫn thoải mái, dễ ứng dụng trong mọi hoàn cảnh.
                        </p>
                        <p>Trải qua quá trình phát triển, ARES CLUB dần xây dựng hệ thống cửa hàng và kênh bán hàng online trên toàn quốc, giúp khách hàng dễ dàng tiếp cận sản phẩm chất lượng với mức giá hợp lý.</p>
                        <p>Mỗi sản phẩm tại ARES CLUB đều được chọn lọc kỹ từ chất liệu đến form dáng, hướng tới sự tối giản, tinh tế và dễ phối đồ trong cuộc sống hàng ngày.</p>
                        <p>Phong cách của ARES CLUB tập trung vào sự gọn gàng, thanh lịch nhưng vẫn gần gũi, dễ mặc. Các dòng sản phẩm như áo polo, sơ mi, quần tây, quần jean… đều được thiết kế theo form chuẩn, dễ chọn size cho khách hàng Việt.</p>
                    </div>
                </section>
                ...
                <section className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
                    ...
                    <div className="w-full">
                        <Image src="https://theme.hstatic.net/200000690725/1001078549/14/about01_introduce2_img.jpg?v=1065" alt="Phụ kiện và thời trang ARES CLUB" width={1200} height={800} className="w-full h-auto object-cover" />
                    </div>
                </section>
            </div>
        </div>
