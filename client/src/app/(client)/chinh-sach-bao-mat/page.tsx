    ...
    return (
        <div className="bg-white py-10 lg:py-16">
            <div className="container mx-auto px-4 max-w-4xl">
                ...
                <h1 className="text-3xl md:text-4xl font-bold tracking-wide mb-10">BẢO MẬT THÔNG TIN KHÁCH HÀNG ARES CLUB</h1>

                {/* Section 1 */}
                <section className="mb-10">
                    <h3 className="font-semibold text-lg mb-3">1. Thu thập và sử dụng thông tin của ARES CLUB</h3>

                    <p className="mb-4 leading-relaxed text-neutral-700">
                        ARES CLUB chỉ thu thập các loại thông tin cơ bản liên quan đến đơn đặt hàng như: họ tên khách hàng, số điện thoại, địa chỉ giao hàng, email và một số thông tin cần thiết khác để phục vụ quá trình mua sắm.
                    </p>
                    ...
                    <p className="mb-4 leading-relaxed text-neutral-700">ARES CLUB cam kết:</p>
                    ...
                    <p className="mt-4 leading-relaxed text-neutral-700">ARES CLUB chỉ cung cấp thông tin cho các đơn vị liên quan khi có yêu cầu hợp pháp từ cơ quan nhà nước hoặc theo yêu cầu của khách hàng.</p>
                </section>
                ...
                <section className="mb-10">
                    ...
                    <p className="mb-4 leading-relaxed text-neutral-700">
                        Chúng tôi đảm bảo rằng mọi thông tin cá nhân được khách hàng cung cấp đều được lưu trữ an toàn. ARES CLUB áp dụng các biện pháp kỹ thuật hiện đại để tránh việc mất mát hoặc tấn công dữ liệu.
                    </p>
                ...
                <section className="mb-10">
                    ...
                    <p className="leading-relaxed text-neutral-700">
                        Khách hàng có trách nhiệm tự bảo mật thông tin tài khoản của mình và không chia sẻ cho người khác. ARES CLUB không chịu trách nhiệm đối với thiệt hại do việc tiết lộ thông tin cá nhân từ phía khách hàng.
                    </p>
                </section>
                ...
                <section className="mb-10">
                    ...
                    <p className="mb-4 leading-relaxed text-neutral-700">Mọi tranh chấp xảy ra giữa Khách hàng và ARES CLUB sẽ được hòa giải. Nếu hòa giải không thành sẽ được giải quyết tại Tòa án có thẩm quyền và tuân theo pháp luật Việt Nam</p>
                </section>
            </div>
        </div>
    );
