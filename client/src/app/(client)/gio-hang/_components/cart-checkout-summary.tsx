            ...
            <section className="space-y-3 border-t border-gray-200 pt-4">
                ...
                {!useNewAddress ? (
                    ...
                    <div className="grid gap-2 text-sm">
                        <input value={newAddress.customer_name} onChange={(event) => onNewAddressChange((current) => ({ ...current, customer_name: event.target.value }))} placeholder="Người nhận" className="h-9 border border-gray-300 px-3" />
                        <input value={newAddress.phone} onChange={(event) => onNewAddressChange((current) => ({ ...current, phone: event.target.value }))} placeholder="Số điện thoại" className="h-9 border border-gray-300 px-3" />
                        <input value={newAddress.province} onChange={(event) => onNewAddressChange((current) => ({ ...current, province: event.target.value }))} placeholder="Tỉnh/Thành" className="h-9 border border-gray-300 px-3" />
                        <input value={newAddress.province_id} onChange={(event) => onNewAddressChange((current) => ({ ...current, province_id: event.target.value }))} placeholder="Mã tỉnh" className="h-9 border border-gray-300 px-3" />
                        <input value={newAddress.district} onChange={(event) => onNewAddressChange((current) => ({ ...current, district: event.target.value }))} placeholder="Quận/Huyện" className="h-9 border border-gray-300 px-3" />
                        <input value={newAddress.district_id} onChange={(event) => onNewAddressChange((current) => ({ ...current, district_id: event.target.value }))} placeholder="Mã quận" className="h-9 border border-gray-300 px-3" />
                        <input value={newAddress.ward} onChange={(event) => onNewAddressChange((current) => ({ ...current, ward: event.target.value }))} placeholder="Phường/Xã" className="h-9 border border-gray-300 px-3" />
                        <input value={newAddress.ward_id} onChange={(event) => onNewAddressChange((current) => ({ ...current, ward_id: event.target.value }))} placeholder="Mã phường" className="h-9 border border-gray-300 px-3" />
                        <input value={newAddress.address} onChange={(event) => onNewAddressChange((current) => ({ ...current, address: event.target.value }))} placeholder="Địa chỉ chi tiết" className="h-9 border border-gray-300 px-3" />
                    </div>
                )}
            </section>
