...
export const LeaveApi = {
    getAll: async (params?: { keyword?: string; status?: string; leave_date?: string; start_date?: string; end_date?: string; sort?: string; page?: number; size?: number }): Promise<ApiResponse<PageResponse<LeaveRequest>>> => {
        try {
    ...
    getMyLeaves: async (params?: { keyword?: string; status?: string; leave_date?: string; start_date?: string; end_date?: string; sort?: string; page?: number; size?: number }): Promise<ApiResponse<PageResponse<LeaveRequest>>> => {
        try {
